...
const routes: Routes = [
    ...
    {path: 'myEvents', component: OrgEventsComponent, canActivate: [AuthGuard] },
    {path: 'admin', component: AdminPanelComponent, canActivate: [AuthGuard] },
    {path: 'admin/users', component: AdminUsersComponent, canActivate: [AuthGuard] },
    {path: 'admin/events', component: AdminEventsComponent, canActivate: [AuthGuard] },
    {path: 'test', component: TestComponent},
    {path: 'organizer', component: OrgPanelComponent, canActivate: [AuthGuard] },
    {path: 'following', component: FollowingComponent, canActivate: [AuthGuard] },
    {path: 'roleRequests', component: RoleRequestComponent, canActivate: [AuthGuard] },
    {path: 'forget', component: PassForgetComponent},
    {path: 'event/tickets/:id', component: EventTicketsComponent, canActivate: [AuthGuard] },
